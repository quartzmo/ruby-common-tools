...
# and configures the `RUBYOPT` environment variable to automatically preload the
# JUnit reporter preloader (`lib/gapic/junit_preloader.rb`) in all child Ruby processes.
#
module GapicJunitHelper
  ...
  #
  # Also configures `RUBYOPT` to require our custom preloader.
  #
  ...
  def setup_junit_wrapper gemfile_path: nil
    ...
    # Set RUBYOPT to require our preloader file using an absolute path
    preloader_path = File.expand_path "../../lib/gapic/junit_preloader.rb", __dir__
    ENV["RUBYOPT"] = "-r#{preloader_path}"
